...
export async function POST(request: NextRequest) {
  try {
    ...
    const enhancedPrompt = `Crea una portada elegante, moderna y profesional. Estilo: ${style || 'Fotorealista y cinemático'}. Sin texto superpuesto. Concepto visual abstracto para un activo digital llamado: "${currentTitle}". Directriz adicional: ${prompt || 'Crea una composición inspiradora y premium.'}. IMPORTANTE: Genera la imagen estrictamente en una proporción (aspect ratio) de ${aspectRatio}.`;
