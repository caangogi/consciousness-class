...
import { LessonEntity } from '@/backend/course/domain/entities/lesson.entity';
import type { ILessonRepository } from '@/backend/course/domain/repositories/lesson.repository';
import type { IModuleRepository } from '@/backend/course/domain/repositories/module.repository';
...
import type { UpdateLessonDto } from '@/backend/course/infrastructure/dto/update-lesson.dto'; // Added
import type { ModuleEntity } from '@/backend/course/domain/entities/module.entity';
