...
export interface CourseProperties {
  ...
  ordenModulos?: string[];
  referralPolicyId?: string | null; // ID de la política de referidos (ReferralPolicyEntity) o null/undefined si no aplica
  stripeProductId?: string | null;
  stripePriceId?: string | null;
  ingresosBrutosGenerados?: number; // Total revenue generated by this course
}
...
export class CourseEntity {
  ...
  stripeProductId: string | null;
  stripePriceId: string | null;
  ingresosBrutosGenerados: number;
  ...
  constructor(props: CourseProperties) {
    ...
    this.fechaPublicacion = props.fechaPublicacion ? parseDate(props.fechaPublicacion) : null;
    ...
    this.referralPolicyId = props.referralPolicyId === undefined ? null : props.referralPolicyId;
    this.stripeProductId = props.stripeProductId === undefined ? null : props.stripeProductId;
    this.stripePriceId = props.stripePriceId === undefined ? null : props.stripePriceId;
    this.ingresosBrutosGenerados = props.ingresosBrutosGenerados || 0;
  }

  static create(
    input: Omit<CourseProperties, 'id' | 'fechaCreacion' | 'fechaActualizacion' | 'estado' | 'ratingPromedio' | 'totalEstudiantes' | 'totalResenas' | 'ordenModulos' | 'referralPolicyId' | 'stripeProductId' | 'stripePriceId' | 'ingresosBrutosGenerados'> & { id?: string, referralPolicyId?: string | null }
  ): CourseEntity {
    const now = new Date();
    ...
    const props: CourseProperties = {
      ...
      totalEstudiantes: 0,
      totalResenas: 0,
      ingresosBrutosGenerados: 0,
      ordenModulos: [],
      imagenPortadaUrl: input.imagenPortadaUrl || null,
      dataAiHintImagenPortada: input.dataAiHintImagenPortada ?? null,
      referralPolicyId: input.referralPolicyId === undefined ? null : input.referralPolicyId,
  ...
  update(data: Partial<Omit<CourseProperties, 'id' | 'creadorUid' | 'fechaCreacion'>>) {
    ...
    if (data.referralPolicyId !== undefined) this.referralPolicyId = data.referralPolicyId;
    if (data.stripeProductId !== undefined) this.stripeProductId = data.stripeProductId;
    if (data.stripePriceId !== undefined) this.stripePriceId = data.stripePriceId;
    if (data.ingresosBrutosGenerados !== undefined) this.ingresosBrutosGenerados = data.ingresosBrutosGenerados;
  ...
  toPlainObject(): CourseProperties {
    return {
      ...
      ingresosBrutosGenerados: this.ingresosBrutosGenerados,
    };
  }
}
