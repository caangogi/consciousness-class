...
export class LessonEntity {
  ...
  constructor(props: LessonProperties) {
    const parseDate = (d: any) => {
      let parsed;
      if (d && typeof d.toDate === 'function') parsed = d.toDate();
      else if (d && d._seconds) parsed = new Date(d._seconds * 1000);
    ...
    this.fechaCreacion = parseDate(props.fechaCreacion);
    this.fechaActualizacion = parseDate(props.fechaActualizacion);
  }
