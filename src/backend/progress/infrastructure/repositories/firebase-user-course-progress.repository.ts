...
import type { IUserCourseProgressRepository } from '@/backend/progress/domain/repositories/user-course-progress.repository';
import { UserCourseProgressEntity, type UserCourseProgressProperties } from '@/backend/progress/domain/entities/user-course-progress.entity';
