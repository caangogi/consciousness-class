...
import { UserEntity, type UserProperties, type UserRole } from '@/backend/user/domain/entities/user.entity';
import type { IUserRepository } from '@/backend/user/domain/repositories/user.repository';
