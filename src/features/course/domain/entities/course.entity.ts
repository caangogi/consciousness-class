...
export class CourseEntity {
  ...
  static create(
    input: Omit<CourseProperties, 'id' | 'fechaCreacion' | 'fechaActualizacion' | 'estado' | 'ratingPromedio' | 'totalEstudiantes' | 'totalResenas' | 'ordenModulos' | 'comisionReferidoPorcentaje' | 'stripeProductId' | 'stripePriceId' | 'ingresosBrutosGenerados'> & { id?: string, comisionReferidoPorcentaje?: number | null }
  ): CourseEntity {
    const now = new Date();
